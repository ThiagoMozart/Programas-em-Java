...
public class Main {
    public static void main(String[] args){
        ...
        home.cor = teclado.next();

        while(aux){
            System.out.println();
            System.out.println("Digite 1 para o estado da porta número 1: ");
            System.out.println("Digite 2 para o estado da porta número 2: ");
            System.out.println("Digite 3 para o estado da porta número 3: ");
        ...
        System.out.println("A casa está com a cor "+ home.cor);
